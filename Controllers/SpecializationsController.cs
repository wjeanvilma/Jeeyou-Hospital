...
namespace JeeyouHospital.Controllers
{
    ...
    public class SpecializationsController : Controller
    {
        ...
        public SpecializationsController(HospitalManagementDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Specializations != null ? 
                          ...
                          Problem("Entity set 'HospitalManagementDbContext.Specializations'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HospitalManagementDbContext.Specializations'  is null.");
            }
            var specialization = await _context.Specializations.FindAsync(id);
            if (specialization != null)
            {
